                            ...
                            <form className="mt-8">
                                <div className="grid lg:grid-cols-12 gap-6">
                                    ...
                                    <div className="lg:col-span-12">
                                        <textarea name="comments" id="comments" className="form-input w-full py-2 px-3 border border-gray-200 dark:border-gray-800 focus:ring-0 focus:border-orange-600/50 dark:bg-slate-900 dark:text-slate-200 rounded h-10 outline-none textarea h-28" placeholder="Message :"></textarea>
                                    </div>
