                ...
                <div className="grid lg:grid-cols-12 mt-10 md:grid-cols-2 gap-2">
                    <div className="lg:col-span-7">
                        ...
                        <div className="relative mt-10">
                            <Link to="#" className="btn bg-orange-600 hover:bg-orange-700 border-orange-600 hover:border-orange-700 text-white rounded-full me-1">Get Started</Link>
                            <Link to="#" onClick={()=>setOpen(!isOpen)} className="btn btn-icon btn-lg bg-orange-600 hover:bg-orange-700 border-orange-600 hover:border-orange-700 text-white rounded-full lightbox"><i className="mdi mdi-play text-xl align-middle"></i></Link><small className="text-white text-sm uppercase align-middle ms-2">Watch Now</small>
                        </div>
                    </div>
                            ...
                            <form>
                                <div className="grid grid-cols-1">
                                    <div className="mb-5">
                                        ...
                                        <input name="name" id="fName" type="text" className="form-input w-full py-2 px-3 border border-gray-200 dark:border-gray-800 focus:ring-0 focus:border-orange-600/50 dark:bg-slate-900 dark:text-slate-200 rounded h-10 outline-none mt-2" placeholder="Name :" />
                                    </div>
                                    <div className="mb-5">
                                        <label className="dark:text-white">Email</label>
                                        <input name="email" id="yEmail" type="email" className="form-input w-full py-2 px-3 border border-gray-200 dark:border-gray-800 focus:ring-0 focus:border-orange-600/50 dark:bg-slate-900 dark:text-slate-200 rounded h-10 outline-none mt-2" placeholder="Email :" />
                                    </div>
                                    <div className="mb-5">
