                                ...
                                <div className="relative">
                                    <div className="relative flex justify-end">
                                        ...
                                        <div className="absolute top-0 translate-y-2/4 start-0 text-center">
                                            <Link to="#" onClick={()=>setOpen(!isOpen)} data-type="youtube" data-id="yba7hPeTSjk" className="lightbox h-20 w-20 rounded-full shadow-lg shadow-slate-100 dark:shadow-slate-800 inline-flex items-center justify-center bg-white dark:bg-slate-900 text-orange-600">
