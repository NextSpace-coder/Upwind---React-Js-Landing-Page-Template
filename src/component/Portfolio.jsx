    ...
    return (
        <>
                            ...
                            <div className="relative rounded-md shadow-xs overflow-hidden group" key={index}>
                                ...
                                <div className="content">
                                    <div className="icon absolute z-10 opacity-0 group-hover:opacity-100 top-4 end-4 transition-all duration-500">
                                        <Link to="#" onClick={() => handleImageClick(index)} className="btn bg-orange-600 hover:bg-orange-700 border-orange-600 hover:border-orange-700 text-white btn-icon rounded-full lightbox">
            ...
            <section
                ...
                <div className="absolute inset bg-slate-900/80 w-full h-full top-0"></div>
